...
with detection_graph.as_default():
    ...
    class detector:
      ...
      def __init__(self):
        ...
        self.button_sub = rospy.Subscriber("/up_down_target", Int8, self.button_cb, queue_size=1)
        self.points_pub = rospy.Publisher("/reference_points", PointsArray, queue_size=1)
        self.button_repeat_pub = rospy.Publisher("/up_down_target", Int8, queue_size=1)
